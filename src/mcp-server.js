// MCP server (stdio) exposing document, asset, and share-link tools so Claude
// can create and manage documents. Run the web server alongside it to view,
// edit, and share what Claude creates.
